...
<head>
    ...
    <title>ECOVISRKDA - Business Support and Financial Reporting
    </title>
                        ...
                        <div class="col-3">
                            <div class="text-center">
                                <div class="mx-auto service_icons">
                                    <img src="<?= base_url()?>assets/images/icon_images/BusinessSupportandFinancialReporting/AccountingServices.png" class="w-75" alt=""> -->
                ...
                <div class="col-md-8">
                    <div class=" mb-3 row" style="border-bottom: 1px solid #cd1432;">
                        <div class="col-3">
                            <div class="text-center">
                                <div class="mx-auto service_icons">
                                    <img src="<?= base_url()?>assets/images/icon_images/BusinessSupportandFinancialReporting/BusinessAnalytics.png" class="w-75" alt=""> -->
                ...
                <div class="col-md-8">
                    <div class=" mb-3 row" style="border-bottom: 1px solid #cd1432;">
                        <div class="col-3">
                            <div class="text-center">
                                <div class="mx-auto service_icons">
                                    <img src="<?= base_url()?>assets/images/icon_images/BusinessSupportandFinancialReporting/IndiaEntryConsulting.png" class="w-75" alt=""> -->
                ...
                <div class="col-md-8">
                    <div class=" mb-3 row" style="border-bottom: 1px solid #cd1432;">
                        <div class="col-3">
                            <div class="text-center">
                                <div class="mx-auto service_icons">
                                    <img src="<?= base_url()?>assets/images/icon_images/BusinessSupportandFinancialReporting/ManagementSystems.png" class="w-75" alt="">
                ...
                <div class="col-md-8">
                    <div class=" mb-3 row" style="border-bottom: 1px solid #cd1432;">
                        <div class="col-3">
                            <div class="text-center">
                                <div class="mx-auto service_icons">
                                    <img src="<?= base_url()?>assets/images/icon_images/BusinessSupportandFinancialReporting/MISDashboards.png" class="w-75" alt="">  -->
                ...
                <div class="col-md-8">
                    <div class=" mb-3 row">
                        <div class="col-3">
                            <div class="text-center">
                                <div class="mx-auto service_icons">
                                    <img src="<?= base_url()?>assets/images/icon_images/BusinessSupportandFinancialReporting/OnGoingBusinessSupport.png" class="w-75" alt=""> -->
                ...
                <h2 class="accordion-header" id="headingOne">
                    <button class="accordion-button" type="button" data-bs-toggle="collapse"
                        ...
                        <div class="mx-auto w-100  d-flex  align-items-center">
                            <img src="<?= base_url()?>assets/images/icon_images/BusinessSupportandFinancialReporting/BusinessAnalytics.png"
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="headingTwo">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        ...
                        <div class="mx-auto w-100  d-flex  align-items-center">
                            <img src="<?= base_url()?>assets/images/icon_images/BusinessSupportandFinancialReporting/ManagementSystems.png"
                                class="" alt="" style='width:80px'>
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="headingThree">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        ...
                        <div class="mx-auto w-100  d-flex  align-items-center">
                            <img src="<?= base_url()?>assets/images/icon_images/BusinessSupportandFinancialReporting/IndiaEntryConsulting.png"
                                class="" alt="" style='width:80px'>
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="headingFour">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        ...
                        <div class="mx-auto w-100  d-flex  align-items-center">
                            <img src="<?= base_url()?>assets/images/icon_images/BusinessSupportandFinancialReporting/AccountingServices.png"
                                class="" alt="" style='width:80px'>
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="headingFive">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        ...
                        <div class="mx-auto w-100  d-flex  align-items-center">
                            <img src="<?= base_url()?>assets/images/icon_images/BusinessSupportandFinancialReporting/OnGoingBusinessSupport.png"
                                class="" alt="" style='width:80px'>
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="headingSix">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        ...
                        <div class="mx-auto w-100  d-flex  align-items-center">
                            <img src="<?= base_url()?>assets/images/icon_images/BusinessSupportandFinancialReporting/MISDashboards.png"
                                class="" alt="" style='width:80px'>
