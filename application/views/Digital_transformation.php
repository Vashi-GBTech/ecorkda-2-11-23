...
<head>
    ...
    <title>ECOVISRKDA - Digital Transformation
    </title>
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="headingOne">
                    <button class="accordion-button" type="button" data-bs-toggle="collapse"
                        ...
                        <div class="mx-auto w-100  d-flex  align-items-center">
                            <img src="<?= base_url()?>assets/images/icon_images/DigitalTransformation/CloudManagementSecurity.png" class="" alt=""
                                style='width:80px'>
                ...
                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                    ...
                    <div class="accordion-body">
                        <p class="ml-3 pl-4 see-more Digital_transformation" style=" font-size: var(--secondry_font_size);">
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="headingTwo">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        ...
                        <div class="mx-auto w-100  d-flex  align-items-center">
                            <img src="<?= base_url()?>assets/images/icon_images/DigitalTransformation/DataAnalytics.png" class="" alt=""
                                style='width:80px'>
                            <p class="primaryHeading text-danger ml-3 mb-0 pl-4">Data Analytics </p>
                        </div>
                    </button>
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="headingThree">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        ...
                        <div class="mx-auto w-100  d-flex  align-items-center">
                            <img src="<?= base_url()?>assets/images/icon_images/DigitalTransformation/CloudInfraServices.png" class="" alt=""
                                style='width:80px'>
                            <p class="primaryHeading text-danger ml-3 mb-0 pl-4">Cloud Infra Services</p>
                        </div>
                    </button>
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="headingFour">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        ...
                        <div class="mx-auto w-100  d-flex  align-items-center">
                            <img src="<?= base_url()?>assets/images/icon_images/DigitalTransformation/SAAS.png" class="" alt=""
                                style='width:80px'>
                            <p class="primaryHeading text-danger ml-3 mb-0 pl-4">SAAS</p>
                        </div>
                    </button>
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="headingFive">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        ...
                        <div class="mx-auto w-100  d-flex  align-items-center">
                            <img src="<?= base_url()?>assets/images/icon_images/DigitalTransformation/MobileWebDevelopment.png" class="" alt=""
                                style='width:80px'>
                            <p class="primaryHeading text-danger ml-3 mb-0 pl-4">Mobile & Web Development</p>
                        </div>
                    </button>
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="headingSix">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        ...
                        <div class="mx-auto w-100  d-flex  align-items-center">
                            <img src="<?= base_url()?>assets/images/icon_images/DigitalTransformation/TechnologyAssessment.png" class="" alt=""
                                style='width:80px'>
