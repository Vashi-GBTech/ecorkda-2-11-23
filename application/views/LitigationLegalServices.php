...
<head>
    ...
    <title>ECOVISRKDA - Legal & Litigation Services
    </title>
                        ...
                        <div class="col-3">
                            <div class="text-center">
                                <div class="mx-auto service_icons">
                                    <img src="<?= base_url()?>assets/images/icon_images/LitigationLegalServices/Litigation.png" class="w-75"
                                        alt="">
                ...
                <div class="col-md-8">
                    <div class=" mb-3 row" style="border-bottom: 1px solid #cd1432;">
                        <div class="col-3">
                            <div class="text-center">
                                <div class="mx-auto service_icons">
                                    <img src="<?= base_url()?>assets/images/icon_images/LitigationLegalServices/BusinessAdvisory.png"
                                        class="w-75" alt="">
                ...
                <div class="col-md-8">
                    <div class=" mb-3 row" style="border-bottom: 1px solid #cd1432;">
                        <div class="col-3">
                            <div class="text-center">
                                <div class="mx-auto service_icons">
                                    <img src="<?= base_url()?>assets/images/icon_images/LitigationLegalServices/PolicyRegulatoryAffairs.png"
                                        class="w-75" alt="">
                ...
                <div class="col-md-8">
                    <div class=" mb-3 row" style="border-bottom: 1px solid #cd1432;">
                        <div class="col-3">
                            <div class="text-center">
                                <div class="mx-auto service_icons">
                                    <img src="<?= base_url()?>assets/images/icon_images/LitigationLegalServices/SecretarialMatters.png"
                                        class="w-75" alt="">
                ...
                <div class="col-md-8">
                    <div class=" mb-3 row">
                        <div class="col-3">
                            <div class="text-center">
                                <div class="mx-auto service_icons">
                                    <img src="<?= base_url()?>assets/images/icon_images/LitigationLegalServices/JVMAIPO.png" class="w-75"
                                        alt="">
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="headingTwo">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        ...
                        <div class="mx-auto w-100  d-flex  align-items-center">
                            <img src="<?= base_url()?>assets/images/icon_images/LitigationLegalServices/SecretarialMatters.png" class="" alt=""
                                style='width:80px'>
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="headingThree">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        ...
                        <div class="mx-auto w-100  d-flex  align-items-center">
                            <img src="<?= base_url()?>assets/images/icon_images/LitigationLegalServices/PolicyRegulatoryAffairs.png" class="" alt=""
                                style='width:80px'>
