...
<head>
    ...
    <title>ECOVISRKDA - Strategy Performance Consulting services</title>
    <link rel="icon" href="<?= base_url()?>images/ecovis_logoes/Ecovis_rkda_logo_ball.png" type="image/icon type">
                    ...
                    <div class=" mb-3 row" style="border-bottom: 1px solid #cd1432;">
                        <div class="col-3">
                            <div class="text-center">
                                ...
                                <img src="<?= base_url()?>assets/images/icon_images/Strategy_Performance_Consulting_services/StrategicThinkingPlanning.png" class="w-75" alt="">
                ...
                <div class="col-md-8">
                    <div class=" mb-3 row" style="border-bottom: 1px solid #cd1432;">
                        <div class="col-3">
                            <div class="text-center">
                                <div class="mx-auto service_icons">
                                <img src="<?= base_url()?>assets/images/icon_images/Strategy_Performance_Consulting_services/NewProductDevelopmentApproach.png" class="w-75" alt="">
                                </div>
                ...
                <div class="col-md-8">
                    <div class=" mb-3 row" style="border-bottom: 1px solid #cd1432;">
                        <div class="col-3">
                            <div class="text-center">
                                <div class="mx-auto service_icons">
                                <img src="<?= base_url()?>assets/images/icon_images/Strategy_Performance_Consulting_services/Processdriven.png" class="w-75" alt="">
                ...
                <div class="col-md-8">
                    <div class=" mb-3 row" style="border-bottom: 1px solid #cd1432;">
                        <div class="col-3">
                            <div class="text-center">
                                <div class="mx-auto service_icons">
                                <img src="<?= base_url()?>assets/images/icon_images/Strategy_Performance_Consulting_services/PerformanceEnablingBusinessGoalsKPIs.png" class="w-75" alt="">
                ...
                <div class="col-md-8">
                    <div class=" mb-3 row" style="border-bottom: 1px solid #cd1432;" >
                        <div class="col-3">
                            <div class="text-center">
                                <div class="mx-auto service_icons">
                                <img src="<?= base_url()?>assets/images/icon_images/Strategy_Performance_Consulting_services/CustomerInsightsEngagement.png" class="w-75" alt="">
                ...
                <div class="col-md-8">
                    <div class=" mb-3 row" >
                        <div class="col-3">
                            <div class="text-center">
                                <div class="mx-auto service_icons">
                                <img src="<?= base_url()?>assets/images/icon_images/Strategy_Performance_Consulting_services/InstitutionalizingRobustPerformanceManagement.png" class="w-75" alt="">
                ...
                <h2 class="accordion-header" id="headingOne">
                    <button class="accordion-button" type="button" data-bs-toggle="collapse"
                        ...
                        <div class="mx-auto w-100  d-flex  align-items-center">
                            <img src="<?= base_url()?>assets/images/icon_images/LitigationLegalServices/Litigation.png" class="" alt=""
                                style='width:80px'>
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="headingTwo">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        ...
                        <div class="mx-auto w-100  d-flex  align-items-center">
                            <img src="<?= base_url()?>assets/images/icon_images/LitigationLegalServices/SecretarialMatters.png" class=""
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="headingThree">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        ...
                        <div class="mx-auto w-100  d-flex  align-items-center">
                            <img src="<?= base_url()?>assets/images/icon_images/LitigationLegalServices/PolicyRegulatoryAffairs.png" class=""
                                alt="" style='width:80px'>
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="headingFour">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        ...
                        <div class="mx-auto w-100  d-flex  align-items-center">
                            <img src="<?= base_url()?>assets/images/icon_images/FinancialCapitalServices/BusinessValuations.png" class=""
                                alt="" style='width:80px'>
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="headingFive">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        ...
                        <div class="mx-auto w-100  d-flex  align-items-center">
                            <img src="<?= base_url()?>assets/images/icon_images/LitigationLegalServices/BusinessAdvisory.png" class="" alt=""
                                style='width:80px'>
                            <p class="primaryHeading text-danger ml-3 mb-0 pl-4">Process Driven Delivery</p>
                        </div>
                    </button>
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="headingSix">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        ...
                        <div class="mx-auto w-100  d-flex  align-items-center">
                            <img src="<?= base_url()?>assets/images/icon_images/LitigationLegalServices/JVMAIPO.png" class="" alt=""
                                style='width:80px'>
