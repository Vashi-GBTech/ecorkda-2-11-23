...
<head>
    ...
    <title>ECOVISRKDA - careers</title>
...
<body>
        ...
        <div class="w-75 mx-auto">
            <div class="row mx-0 border border-danger mb-4" style="border-radius: 7px;box-shadow: 0px 1px 5px 1px #cececc">
                ...
                <div class="col-md-9">
                    ...
                    <div class="my-4 pt-2 text-center w-75"><a src="<?=base_url()?>welcome/Marketing_head"><button style="    box-shadow: 0px 1px 5px 1px grey" class="btn btn-danger px-4 font-weight-bold text-light">VIEW DETAILS</button></a></div>
                </div>
            ...
            <div class="row mx-0 border border-danger mb-4" style="border-radius: 7px;     box-shadow: 0px 1px 5px 1px #cececc">
                ...
                <div class="col-md-9">
                    ...
                    <p class="job_post_discription w-75">Want to be a part of India's most innovative and creative commerce industry, backed by a worldclass team, a long-term vision, and top global investors? Don't just wish for it, work with us!</p>
                    <div class="my-4 pt-2 text-center w-75"><a href="<?=base_url()?>welcome/Business_Analyst"><button style="    box-shadow: 0px 1px 5px 1px grey" class="btn btn-danger  px-4 font-weight-bold text-light">VIEW DETAILS</button></a></div>
                </div>
    ...
    <div class="lets_connect px-0 text-center">
       <a href="<?=base_url()?>welcome/jobApplication"> <button type="submit" class="lets_connect_button" style="box-shadow: 0px 1px 4px 1px grey;cursor: pointer;">APPLY</button></a>
