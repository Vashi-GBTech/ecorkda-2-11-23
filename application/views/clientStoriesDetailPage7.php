...
<head>
    ...
    <title>ECOVISRKDA - Redesigning of an American Wholesale Company.
    </title>
    ...
    <div class="container-fluid my-4">
        <div class="row">
            <div class="col-md-12 d-flex justify-content-center">
                <a href="<?=base_url()?>welcome/clientStoriesDetailPage6"><button class="btn box_shadow btn-dark normalText">PREVIOUS STORY</button></a>
                <button class="btn box_shadow btn-danger normalText mx-2">CLIENT STORIES</button>
                <a href="<?=base_url()?>welcome/clientStoriesDetailPage8"><button class="btn box_shadow btn-dark normalText">NEXT STORY</button></a>
            </div>
        </div>
    </div>
