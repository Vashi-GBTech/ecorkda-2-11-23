...
<head>
    ...
    <title>ECOVISRKDA - Contact Us</title>
    ...
    <div class="banner ">
        ...
        <div class="align-items-center d-flex justify-content-around mb-5">
            <div class="align-items-center d-flex ">
               ...
               <a href="<?=base_url()?>welcome/ecovis_india"> <button class="btn btn-danger btn-sm font-weight-bold px-3 text-light">View our Location</button></a>
            </div>
            <div class="align-items-center d-flex ">
                <span><i class="fa-solid text-danger fa-envelope mr-2" style="font-size: x-large;"></i></span>
                <a href="https://rmt.ecovisrkca.com/email_client1">info@ecovisrkda.com</a>
            </div>
        </div>
    </div>
    <!-- footer  -->
