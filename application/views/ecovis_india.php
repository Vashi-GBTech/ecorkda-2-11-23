...
<body onload="onLoadPage()">
 ...
 let Members =
  [
        {
            name:'CA Balmukund Gattani',
            keyname: 'B_M_Gattani_&_Co',
            compName: 'B M Gattani & Co',
            post:'Strategy & Performance Consulting',
            location:'kolkata',
        },
        {
            name:'CA Rakesh Patni',
            keyname: 'RK_patni_&_Co',
            compName: 'RK Patni & Co',
        ...
        },
        {
            ...
            compName: 'B L Chordia & Co, Jaipur',
            post:'Strategy & Performance Consulting',
            location:'delhi',
        },
        {
            ...
            compName: 'Atul Somani & associates, Bhilwara',
            post:'Business Support & Financial Reporting',
            location:'patna',
        },
        {
            name:'CA Saurabh Sahu',
            keyname: 'CA_Saurabh_Sahu_Raipur',
            compName: 'Sourabh Sahu & Co',
...
// console.log(data,'datatatat');
    ...
    function commomMapfunction(array) {
        ...
        array.map((member, index) => {
            mappedCards += `<div class="col-md-3 my-2">
                    <a href="" style='text-decoration:none;color:black !important'>
                    <div class="card  p-3 my-2 h-100 bg-gray-ipm" style='border:none'>
                   
                     <h5 class="text-center" >${member.compName}</h5> 
                     <span class='textAlignEnd'>- ${member.name}</span>
