    ...
    <footer style="background:#1d252d;" class="d-none d-md-block">
        ...
        <div class="row mx-0">
            ...
            <div class="col-md-2 ">
                <div class="Careers">
                    <ul  class="font-italic">
                        <a href="<?=base_url()?>welcome/careers " class="text-center"><li>Careers</li></a>
                        <a href="<?=base_url()?>welcome/jobApplication " class="text-center"><li>Work with us</li></a>
                    </ul>
                </div>
            </div>
            <div class="col-md-2 ">
                <div class="Contactus">
                    <ul  class="font-italic">
                        <a href="<?=base_url()?>welcome/contact_us "><li class="text-light">Contact us</li></a>
                ...
                <div class="d-flex">
                    ...
                    <div class="menus w-50">
                        <ul class="font-italic pl-0">
                            ...
                            <a href="<?=base_url()?>welcome/contact_us ">
                                <li class="text-light">Contact us</li>
                            </a>
                            <a href="<?=base_url()?>welcome/jobApplication ">
                                <li>Work with us</li>
                            </a>
                        </ul>
                    </div>
