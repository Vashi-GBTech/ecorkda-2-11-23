...
<body>
    ...
    <div class="container-fluid">
        <div class='my-3 mx-2'>
            <h2 class='acc-for-heading'>Legal Task Force</h2>
        </div>
        <div class="d-flex">
            <div class="col-md-7" >
            <div class=" d-flex justify-content-between" style="flex-wrap:wrap" >
              <div>
                <img src="<?=base_url()?>assets/OurTeam/06_Sanjeev_Bindal.jpg" class="af-img" alt="" srcset="">
                <h6 class="my-1" ><a href="#" class="af-names mb-0 mt-2 px-2" >Sanjiv Bindal</a></h6>
              </div>
              <!-- <div>
