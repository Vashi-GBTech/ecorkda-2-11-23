...
<body>
    <div class='content'>
        <h4 class='mb-3 text-uppercase'>Power of Community </h4>
        <p class=' text-justify' style='color: #726b6b;'>As a member of the RKDA community, enjoy significant advantages
