                    ...
                    <form class='row'>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control contact-number-input" id="contactNumber"
                        ...
                        <div class="form-group col-md-12">
                            <label for="membershipNumber">Membership/Registration Number <span
                                    class='text-danger'>*</span></label>
                            <input type="text" class="form-control" id="membershipNumber" placeholder="Enter Number">
                        </div>
                        <div class="form-group col-md-12">
                            <label for="linkedinUrl">LinkedIn URL</label>
                            <input type="text" class="form-control" id="linkedinUrl" placeholder="Enter LinkedIn URL">
                        </div>
                        <div class="form-group col-md-12 d-flex justify-content-center mb-0">
                            <button type="submit" class="btn btn-danger my-0 rounded-pill btn-block w-50">Sign
                                Up</button>
                        </div>
                        <div class="form-group col-md-12 login-link ">
                            <a href="#" class='text-dark'>Already have an account? <span class='text-danger'
                                    style='font-weight:500;'>Login</span> </a>
                        </div>
                    </form>
                </div>
            </div>
