...
<head>
    ...
    <title>Self-Inspection & Interoffice Review</title>
</head>
...
<body>
    ...
    <div class="container-fluid">
        <div class='my-3 mx-2'>
            <h1 class='acc-for-heading'>Self-Inspection & Interoffice Review</h1>
        </div>
        <div class="d-flex">
            <div class="col-md-7" >
            <div class=" d-flex justify-content-between" style="flex-wrap:wrap" >
              <div>
                <img src="<?=base_url()?>assets/OurTeam/01_Pankaj_Bhargava.jpg" class="af-img" alt="" srcset="">
                <h6 class="my-1" ><a href="#" class="af-names mb-0 mt-2 px-2" >Pankaj Bhargava</a></h6>
              </div>
              <div>
