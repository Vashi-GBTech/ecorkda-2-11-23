...
<section id='membership' >
    <div class="container mt-5">
       <div class='d-flex justify-content-center ' ><div class="header w-75">Technology</div></div> 

        <div class="d-flex h-100 mt-5">
          <div class="col-md-8  d-flex justify-content-start">
            <div>
           <div class='d-flex justify-content-center' >
           <p class='w-75'>Our technology professionals offer innovative IT solutions that drive digital transformation and enhance your business operations. We implement cutting-edge software, improve cybersecurity measures, and streamline IT infrastructure to boost efficiency and competitiveness. Our team stays ahead of technological trends, ensuring that your business leverages the latest advancements to achieve operational excellence and sustained growth.
           </p>
