...
<body>
    ...
    <div class="container-fluid">
        <div class='my-3 mx-2'>
            <h2 class='acc-for-heading'>Women Leadership Group</h2>
        </div>
        <div class="d-flex">
            <div class="col-md-7" >
            <div class=" d-flex justify-content-between" style="flex-wrap:wrap" >
              <div>
                <img src="<?=base_url()?>assets/OurTeam/shruti-ambegaonkar.jpg" class="af-img" alt="" srcset="">
                <h6 class="my-1" ><a href="#" class="af-names mb-0 mt-2 px-2" >Shruti Ambegaonkar</a></h6>
              </div>
              <!-- <div>
