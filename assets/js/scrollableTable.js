 ...
 function scrollableTable(id, wrapperId, enableLogging=false) {
    // console.log("test1");
    ...
    this.sortByColumnIndex = function(columnIndex) {
        ...
        $('#'+id+' > thead > tr > th > div').css('background-image', "url('assets/unsorted-icon.png')")
        if (sortDir == -1) columnButton.children('div').css('background-image', "url('assets/dasc-icon.png')")
        else columnButton.children('div').css('background-image', "url('assets/asc-icon.png')")
